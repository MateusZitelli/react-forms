...
var $__0=      Immutable,Iterable=$__0.Iterable,Map=$__0.Map,Record=$__0.Record,fromJS=$__0.fromJS,is=$__0.is;
var Value                               = require('../Value');
var $__1= 
    
                 require('../schema'),Scalar=$__1.Scalar,ScalarNode=$__1.ScalarNode,Mapping=$__1.Mapping,MappingNode=$__1.MappingNode,List=$__1.List,Node=$__1.Node,CompositeNode=$__1.CompositeNode;
...
describe('Value:', function() {
  ...
  describe('Value.create(schema, initial):', function() {
    ...
    function itGrows(schema, initial, expected) {
      ...
      var root = function()  {return grown;};
  ...
  describe('Value.prototype.keys():', function() {
    ...
    it('returns an iterable of keys', function() {
      ...
      var onUpdate = emptyFunction;
      var root = function()  {return undefined;};
  ...
  describe('Value.prototype.map(func):', function() {
    ...
    it('maps value over a function to an array', function() {
      ...
      var root = function()  {return value;};
      var value = Value.create(schema, {x: [1, 2, 3], y: 2, z: 3}, onUpdate, root);
      assertEquals(value.map(function(v)  {return v.value;}), [[1, 2, 3], 2, 3]);
      assertEquals(value.get('x').map(function(v)  {return v.value;}), [1, 2, 3]);
    });
  ...
  describe('Value.prototype.set(value):', function() {
    ...
    it('updates nested mapping', function() {
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x', 'y']).set(2);}
      );
      return;
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x', 'y']).set('x');}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x']).set({y: 3});}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x']).set({y: 'x'});}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.set({x: {y: 4}});}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.set({x: {y: 'x'}});}
      );
    ...
    it('updates nested mapping (no default)', function() {
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x']).set([]);}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x', 0]).set({y: 1});}
      );
      ...
      itUpdates(
        ...
        function(value)  {return value.getIn(['x', 0, 'y']).set(3);}
      );
    });
...
describe('Value with dynamic schema:', function() {
  ...
  for(var MappingNode____Key in MappingNode){if(MappingNode.hasOwnProperty(MappingNode____Key)){TextType[MappingNode____Key]=MappingNode[MappingNode____Key];}}var ____SuperProtoOfMappingNode=MappingNode===null?null:MappingNode.prototype;TextType.prototype=Object.create(____SuperProtoOfMappingNode);TextType.prototype.constructor=TextType;TextType.__superConstructor__=MappingNode;function TextType(){if(MappingNode!==null){MappingNode.apply(this,arguments);}}

    Object.defineProperty(TextType.prototype,"defaultValue",{enumerable:true,configurable:true,get:function() {
      return fromJS({type: 'text', pattern: 'x'});
    }});

    TextType.prototype.getChildren=function() {
      return Map({
  ...
  for(MappingNode____Key in MappingNode){if(MappingNode.hasOwnProperty(MappingNode____Key)){NumberType[MappingNode____Key]=MappingNode[MappingNode____Key];}}NumberType.prototype=Object.create(____SuperProtoOfMappingNode);NumberType.prototype.constructor=NumberType;NumberType.__superConstructor__=MappingNode;function NumberType(){if(MappingNode!==null){MappingNode.apply(this,arguments);}}

    Object.defineProperty(NumberType.prototype,"defaultValue",{enumerable:true,configurable:true,get:function() {
      return fromJS({type: 'number'});
    }});

    NumberType.prototype.getChildren=function() {
      return Map({
  ...
  for(var Node____Key in Node){if(Node.hasOwnProperty(Node____Key)){Type[Node____Key]=Node[Node____Key];}}var ____SuperProtoOfNode=Node===null?null:Node.prototype;Type.prototype=Object.create(____SuperProtoOfNode);Type.prototype.constructor=Type;Type.__superConstructor__=Node;
    ...
    Object.defineProperty(Type.prototype,"defaultValue",{enumerable:true,configurable:true,get:function() {
    ...
    Type.prototype.instantiate=function(value) {
      ...
      switch (type) {
        case 'text':
          return {node: this.textType, value:value};
        case 'number':
          return {node: this.numberType, value:value};
      }
    };
...
describe('Value with recursive schema:', function() {
  ...
  for(var CompositeNode____Key in CompositeNode){if(CompositeNode.hasOwnProperty(CompositeNode____Key)){TreeChildren[CompositeNode____Key]=CompositeNode[CompositeNode____Key];}}var ____SuperProtoOfCompositeNode=CompositeNode===null?null:CompositeNode.prototype;TreeChildren.prototype=Object.create(____SuperProtoOfCompositeNode);TreeChildren.prototype.constructor=TreeChildren;TreeChildren.__superConstructor__=CompositeNode;function TreeChildren(){if(CompositeNode!==null){CompositeNode.apply(this,arguments);}}

    Object.defineProperty(TreeChildren.prototype,"defaultValue",{enumerable:true,configurable:true,get:function() {
      return Map();
    }});

    TreeChildren.prototype.keys=function(value) {
      return value.keys();
    };

    TreeChildren.prototype.has=function(key) {
      return true;
    };

    TreeChildren.prototype.get=function(key) {
      return treeNode;
    };
...
describe('Value.prototype.validation', function() {
  ...
  for(var ScalarNode____Key in ScalarNode){if(ScalarNode.hasOwnProperty(ScalarNode____Key)){NumericScalarNode[ScalarNode____Key]=ScalarNode[ScalarNode____Key];}}var ____SuperProtoOfScalarNode=ScalarNode===null?null:ScalarNode.prototype;NumericScalarNode.prototype=Object.create(____SuperProtoOfScalarNode);NumericScalarNode.prototype.constructor=NumericScalarNode;NumericScalarNode.__superConstructor__=ScalarNode;function NumericScalarNode(){if(ScalarNode!==null){ScalarNode.apply(this,arguments);}}

    NumericScalarNode.prototype.validate=function(value) {
  ...
  describe('get', function() {
    ...
    it('does not validate undefined values', function() {
      ...
      var value;
      var schema = Mapping({x: Scalar({validate:validate})});
      var onUpdate = emptyFunction;
      var root = function()  {return value;};

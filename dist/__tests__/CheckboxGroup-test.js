...
describe('forms', function()  {
  ...
  describe('CheckboxGroup', function() {
    ...
    function createAndMount(props) {
      var element = React.createElement(CheckboxGroup, React.__spread({},  props));
    ...
    function getCheckboxesDOM(component) {
      return TestUtils.scryRenderedDOMComponentsWithClass(
        component,
        "rf-CheckboxGroup__checkbox").map(function(c)  {return c.getDOMNode();});
    }

    function assertChecked(boxes, values) {
      assert.equal(
        boxes.filter(function(b) 
          {return b.checked && values.indexOf(b.value) > -1;}).length,
        values.length);
    }

...
describe('ReactForms', function() {
  ...
  describe('<Checkbox />', function() {
    ...
    function render(props) {
      var element = React.createElement(Checkbox, React.__spread({},  props));
    ...
    it('renders into checkbox', function() {
      ...
      var component = render({value: false, onChange:onChange});
    ...
    it('renders correct "checked" property based on value', function() {
      ...
      component = render({value: false, onChange:onChange});
      input = getInput(component);
      assert.ok(!input.getDOMNode().checked);

      component = render({value: true, onChange:onChange});
      input = getInput(component);
      assert.ok(input.getDOMNode().checked);
    });
